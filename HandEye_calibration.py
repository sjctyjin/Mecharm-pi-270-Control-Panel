...
'''
def HandEye_Calibration(file,camera_matrix,chess_board_x_num=8,chess_board_y_num=6,save_RT=0,show_RT_validate=1):
    #機械手臂位置及相機拍攝圖片
    lsdir = file
...
if __name__ == '__main__':
    ...
    parser.add_argument("--file",default='2023_03_20_11_29_41',help="請輸入校正影像及pos手臂資訊的儲存資料夾路徑")
    ...
    HandEye_Calibration(args.file,args.mtx,args.conner_x_num,args.conner_y_num,args.save_RT,args.show_RT_validate)