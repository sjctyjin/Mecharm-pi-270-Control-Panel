...
if __name__ == '__main__':
    ...
    parser.add_argument("--file", default='2023_03_20_11_29_41/img', help="請輸入校正影像儲存資料夾路徑")
    ...
    calibration(args.file,args.save_dist,args.save_corner,args.conner_x_num,args.conner_y_num)